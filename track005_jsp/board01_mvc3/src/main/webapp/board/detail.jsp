	...
	<div class="container card my-5">
		...
		<div class="alert alert-secondary my-3">
			...
			<div class="my-3 text-end">
				<a href="BEditView.do?bno=${board.bno}" class="btn btn-outline-primary" title="글수정">수정</a> 
				<a href="BDeleteView.do?bno=${board.bno}" class="btn btn-outline-success" title="글삭제">삭제</a>
				<a href="BList.do" class="btn btn-primary" title="목록보러가기">목록</a>
			</div>
		</div>
	</div>
