...
public class PagingUtil {
    ...
    private int prev;      // 이전 블록 첫 번째 페이지 번호
    private int next;      // 다음 블록 첫 번째 페이지 번호
	
    private boolean hasPrev;  // start > 1
    private boolean hasNext;  // end < totalPages
