...
▶ 2. 인증  VS  인가
 - 인증  Authentication - [본인]이 맞는지 확인      : 여권가지고 비행기탑승, 로그인
...
1) insert 구문 찾기
insert authorities (email, auth) values ('first@gmail.com','ROLE_MEMBER');

2) join 이용해서 first@gmail.com의 email, bpass, auth 필드값 찾기
